...
import dms_logo from '../../assets/dms_front.png'
  ...
  return (
    <div className=' w-full h-screen '>
       <div className='flex flex-row items-start justify-start w-full h-full '>
        ...
        <img src={dms_logo} className=" h-12 w-30"/>
         </div>
         ...
         <Side_Bar/>
          ...
          <div className='flex flex-col  w-full h-full '>
            <div className='flex flex-row items-center justify-between my-2 mx-4 bg-gradient-to-t bg-[#1A4D2E] rounded-sm h-12 drop-shadow'>
              <div className=' mx-2 text-white font-headerFont text-xl font-semibold font-RobotoBold'>
                    {/* header here... */}
                </div>
                <div className='flex mx-3'>
                  {/* header right content... */}
              <h1 className={`font-RobotoMedium text-base group-hover:shadow xl:flex hidden text-white mr-5`}>Hi, Welcome Back {username.firstname}</h1>
